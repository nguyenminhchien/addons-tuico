...
class tco_task(models.Model):
    ...
    name = fields.Char(string='Test Number', required=True, readonly=False, index=True, default=lambda self: _('New'), tracking=True)
    clm_Updatedate = fields.Datetime('Modify Date', related='project_id.clm_Updatedate')
    clm_color = fields.Many2one('product.color', string='Color', related='project_id.clm_color')
    clm_MaterialCompound = fields.Many2one('product.product', string='Material', related='project_id.clm_MaterialCompound')
    ...
    clm_polymer = fields.Char('Polymer')
    clm_descriptionVN = fields.Char('DescriptionVN')
    ...
    project_new = fields.Boolean(related="project_id.clm_cmpNew", store=True)
    ...
    clm_mn_Temp = fields.Float('Temp')
    clm_mn_ML = fields.Float('ML')
    clm_mn_MF = fields.Float('MF')
