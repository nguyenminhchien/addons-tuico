...
class tco_testing(models.Model):
    ...
    def _onchange_result_value(self):
        ...
        # use update database
        # update tco_testing set
        # clm_result_min_value = round(split_part(clm_result_value, '~', 1)::real::numeric, 2),
        # clm_result_max_value = round(split_part(clm_result_value, '~', 2)::real::numeric, 2)
        # where clm_result_value is not null
